...
export default function CardEquiposMolecules({ nombre, descripcion, tipo, ambiente, register }) {
  ...
  return (
    <DivContent>
      ...
      <Texto><b>Descripcion:</b> {descripcion}</Texto>
      <Texto><b>Tipo:</b> {tipo}</Texto>
      <Texto><b>Ambiente:</b> {ambiente}</Texto>
