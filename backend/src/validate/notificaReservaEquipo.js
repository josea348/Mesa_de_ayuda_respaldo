...
export const validarNotificaReservaEquipo = [
  check('titulo')
  ...
  check('res_equipo_id')
    .notEmpty().withMessage('El ID de reserva de equipo es obligatorio')
    .isNumeric().withMessage('El ID de reserva debe ser numérico')
];
